...
function CadastroItem() {
    ...
    async function criarServico(){
        ...
        const servicosResponse = await api.post('servico',{
    ...
    return (
        <C.GlobalContainer>
            ...
            <C.ContainerCadastro>
                <C.RowContainer>
                    <C.TextoAlto>Nome do Serviço:</C.TextoAlto>
                    <C.InputMaior id='nome_servico' onChange = {(event) => {setNomeServico(event.target.value)}}></C.InputMaior>
                </C.RowContainer>
                <C.RowContainer>
                    <C.TextoAlto>Valor do Serviço: R$</C.TextoAlto>
                    <C.InputMenor onChange = {(event) => {setValorServico(event.target.value)}}></C.InputMenor>
                </C.RowContainer>
